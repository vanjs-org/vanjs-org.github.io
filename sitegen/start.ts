...
`),
    ...
    p("The current version of ", VanJS(), " is ", Symbol(version), " (", Link("announcement", "https://github.com/vanjs-org/van/discussions/53"), "). You can find all relevant ", VanJS(), " files to download in the table below:"),
