...
export default (doc: HTMLDocument) => {
  ...
  return div({id: "content"},
    H1(VanX(), ": The 1.2kB Official VanJS Extension"),
    div("📣 ", Link(VanX(), " 0.4.0 brings lots of new features →", "https://github.com/vanjs-org/van/discussions/292")),
    p(VanX(), " is the official extension of ", VanJS(), ", which provides handy utility functions. ", VanX(), " makes ", VanJS(), " more ergonomic for certain use cases and its developer experience closer to other popular UI frameworks. Like ", VanJS(), ", ", VanX(), " is also ultra-lightweight, with just 1.2kB in the gzipped minified bundle."),
    H2("Installation"),
...
`),
  ...
  vanX.noreactive(new ArrayBuffer(16)),
    ...
    p("we will treat the ", Symbol("ArrayBuffer"), "s in ", Symbol("data"), " as primitive fields instead of further converting them into reactive objects. This feature is essential as the objects of certain native or 3rd party classes ", Link("can't be correctly converted into reactive objects", "#caveat-native-reactivity"), ". ", Symbol("ArrayBuffer"), " is one example as wrapping it around a ", Symbol("Proxy"), " will cause problems."),
    p("Below is the whole example that illustrates how ", Symbol("vanX.noreactive"), " helps a reactive array of ", Symbol("ArrayBuffer"), " being used in the application:"),
...
`,
    ...
    ul(
      ...
      li(SymLink("vanX.noreactive", "#api-noreactive")),
