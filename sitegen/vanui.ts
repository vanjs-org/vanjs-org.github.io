  ...
  return div({id: "content"},
    ...
    pre(
      code({class: "language-html"},
        "<script type=\"text/javascript\" src=\"https://cdn.jsdelivr.net/npm/vanjs-ui@0.11.9/dist/van-ui.nomodule.min.js\"></script>\n",
      ),
    ),
    p(
      Symbol(
        "https://cdn.jsdelivr.net/npm/vanjs-ui@0.11.9/dist/van-ui.nomodule.js",
      ),
