  ...
  return div({id: "content"},
    ...
    pre(
      code({class: "language-html"},
        "<script type=\"text/javascript\" src=\"https://cdn.jsdelivr.net/npm/vanjs-ui@0.11.14/dist/van-ui.nomodule.min.js\"></script>\n",
      ),
    ),
    p(
      Symbol(
        "https://cdn.jsdelivr.net/npm/vanjs-ui@0.11.14/dist/van-ui.nomodule.js",
      ),
    ...
    p(
      ...
      Link(
        "Modal",
        "https://jsfiddle.net/1brxdjh9/",
      ),
      ", ",
      Link(
        "MessageBoard",
        "https://jsfiddle.net/cb9rs5yu/",
      ),
      ".",
    ),
    H3(
