...
`),
    ...
    H3("Reative Programming without React/JSX"),
    p("Declarative DOM tree composition, reusable components, reative state binding - ", VanJS(), " offers every good aspect that React does, but without the need of React, JSX, transpiling, virtual DOM, or any hidden logic. Everything is built with simple JavaScript functions and DOM."),
    H3("Grab 'n Go"),
    ...
    p(
      a({class: "github-button", href: "https://github.com/vanjs-org/van", "data-icon": "octicon-star", "aria-label": "Star vanjs-org/van on GitHub"},
        "Star",
      ), " ",
      a({class: "github-button", href: "https://github.com/vanjs-org/van/subscription", "data-icon": "octicon-eye", "aria-label": "Watch vanjs-org/van on GitHub"},
        "Watch",
      ), " ",
      a({class: "github-button", href: "https://github.com/vanjs-org/van/issues", "data-icon": "octicon-issue-opened", "aria-label": "Issue vanjs-org/van on GitHub"},
        "Issue",
      ),
    ),
