...
`),
    ...
    p({style: "display: flex; align-items: center;"},
      svg({height: "16", "aria-hidden": "true", viewBox: "0 0 16 16", version: "1.1", width: "16", "data-view-component": "true", style: "margin-right: 6px;"},
    ...
    p({class: "contact"},
      "Contact us: ", mailIcon, Link("tao@vanjs.org", "mailto:tao@vanjs.org"), " / ", linkedIcon, Link("Tao Xin", "https://www.linkedin.com/in/tao-xin-64234920/"), " / ", twitterIcon, Link("@taoxin", "https://twitter.com/taoxin"),
    ),
  )
}
