...
`),
    ...
    Js("const {a, div, li, p, ul} = van.tags"),
    p("we have built a ", Link("VS Code extension", "https://marketplace.visualstudio.com/items?itemName=TaoXin.vanjs-importtag"), " with command that can automatically import the tag fucntion at the cursor. You can check out its ", Link("GitHub repo", "https://github.com/vanjs-org/vanjs-importtag"), " for more details."),
