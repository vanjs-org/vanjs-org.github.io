...
export default (doc: HTMLDocument) => {
  ...
  return div({id: "content"},
    ...
    p("There is a simple way to check if the property exists for a given ", Symbol("<key>"), " of a specific element type: in the newly created object ", Symbol("dom"), " of that element type (e.g.: created via ", InlineJs("document.createElement(<tagName>)"), "), check if the value of ", InlineJs("dom[<key>]"), " is ", SymLink("undefined", "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/undefined"), ". If the value is ", Symbol("undefined"), ", that means the property doesn't exist for the specific element type and ", VanJS(), " will assign the value via ", Symbol("setAttribute"), ", otherwise ", VanJS(), " will assign the value via property. Note that, even if the initial property value of certain ", Symbol("<key>"), " is ", SymLink("null", "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/null"), ", the property is considered exist for ", Symbol("<key>"), ". For instance, all ", Symbol("on..."), " handlers are initialized to ", Symbol("null"), " when the element object is created."),
