...
`),
  ...
  div(span({class: "label"}, "throttled:"), () => throttled.val.toFixed(2)),
    ...
    p("In ", Symbol("State"), "-derived properties and ", Symbol("State"), "-derived child nodes, it is guaranteed that the binding function will be triggered, and only be triggered to generate new UI content when the dependency states change. This is true even for complex binding functions, who have different dependency states on different conditions."),
    p(Demo()),
