...
export default (doc: HTMLDocument) => {
  ...
  return div({id: "content"},
    ...
    div({style: "overflow: auto;"},
      ...
      p("Hello all,"),
      p("I'm Tao Xin, a senior staff software engineer at Google, and I'm the founder of ", VanJS(), ". I would like to talk about 2 central questions about ", VanJS(), ": What ", VanJS(), " really is, and why I think it's good to the world."),
      p("So, what is ", VanJS(), "? Well, it's a reactive UI framework. It's ", b("more than 100 times"), " smaller than React. It doesn't require installation, configuration, dependencies or transpiling to use. But I think, in a nutshell, the best way to describe it is: ", i(VanJS(), " is the scripting language for UI, just like ", Symbol("bash"), " is the scripting language for terminal.")),
    ...
    p(VanJS(), " was built by Tao Xin during his personal time while being employed as a full-time employee at Google. The project was submitted to Invention Assignment Review Committee at Google where Google, after reviewing the designated scopes, waived its copyright claims. Thus the copyright of ", VanJS(), " belongs to its creater, all rights reserved. ", VanJS(), " is open sourced under MIT license."),
    ...
    H2("How Do We Ensure the Reliability of ", VanJS(), "?"),
    ...
    ul(
      li("A browser-based test suite, with 200+ test cases, covering different versions of ", VanJS(), " files (", Symbol(".min.js"), ", ", Symbol(".debug.js"), ", ", Symbol(".nomodule.min.js"), ", etc.), including the coverage of advanced behavior such as garbage collection, as well as error messages shown in the debug mode."),
