...
export default (doc: HTMLDocument) => {
  ...
  return div({id: "content"},
    ...
    ul(
      li("A browser-based test suite, with 400+ test cases, covering different versions of ", VanJS(), " files (", Symbol(".min.js"), ", ", Symbol(".debug.js"), ", ", Symbol(".nomodule.min.js"), ", etc.), including the coverage of advanced behavior such as ", Link("garbage collection", "/advanced#gc"), ", as well as error messages shown in the debug mode."),
